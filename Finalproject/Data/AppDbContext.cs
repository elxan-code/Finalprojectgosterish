...
namespace Finalproject.Data
{
    public class AppDbContext:IdentityDbContext
    {
        ...
        public DbSet<FeatureTitle> FeatureTitles { get; set; }
        public DbSet<ProductImage> ProductImages { get; set; }
        public DbSet<ProductToProduct> ProductToProducts { get; set; }
        public DbSet<ProductFature> ProductFatures { get; set; }
        public DbSet<ProductOfProduct> ProductOfProducts { get; set; }
