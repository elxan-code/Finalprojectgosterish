...
namespace Finalproject.Migrations
{
    ...
    [Migration("20220511203445_newnemne")]
    partial class newnemne
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Finalproject.Models.Chat", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Finalproject.Models.FeatureTitle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Finalproject.Models.ProductFature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("FeatureChild")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<string>("FeatureMain")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");

                    b.Property<int>("ProductOfProductId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ProductOfProductId");

                    b.ToTable("ProductFatures");
                });
            ...
            modelBuilder.Entity("Finalproject.Models.ProductImage", b =>
                {
                    ...
                    b.Property<int>("ProductToProductId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("ProductToProductId");

                    b.ToTable("ProductImages");
                });

            modelBuilder.Entity("Finalproject.Models.ProductOfProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ProductOfProducts");
                });

            modelBuilder.Entity("Finalproject.Models.ProductToProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Finalproject.Models.SaleItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Finalproject.Models.SubFeature", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Finalproject.Models.Chat", b =>
                {
                    b.HasOne("Finalproject.Models.CustomUser", "Reciever")
                        .WithMany()
                        .HasForeignKey("RecieverId");

                    b.HasOne("Finalproject.Models.CustomUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("Finalproject.Models.FeatureTitle", b =>
                {
                    b.HasOne("Finalproject.Models.Product", "Product")
                        .WithMany("FeatureTitles")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Finalproject.Models.SubFeature", "SubFeature")
                        .WithMany("FeatureTitles")
            ...
            modelBuilder.Entity("Finalproject.Models.ProductFature", b =>
                {
                    b.HasOne("Finalproject.Models.ProductOfProduct", "ProductOfProduct")
                        .WithMany("ProductFatures4")
                        .HasForeignKey("ProductOfProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProductOfProduct");
                });

            modelBuilder.Entity("Finalproject.Models.ProductImage", b =>
                {
                    b.HasOne("Finalproject.Models.ProductToProduct", "ProductToProduct")
                        .WithMany("ProductImages")
                        .HasForeignKey("ProductToProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProductToProduct");
                });

            modelBuilder.Entity("Finalproject.Models.ProductOfProduct", b =>
                {
                    b.HasOne("Finalproject.Models.Product", "Product")
                        .WithMany("ProductOfProducts")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Finalproject.Models.Sale", b =>
                {
                    b.HasOne("Finalproject.Models.CustomUser", "CustomUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Finalproject.Models.Product", b =>
                {
                    ...
                    b.Navigation("FeatureTitles");

                    b.Navigation("ProductOfProducts");
